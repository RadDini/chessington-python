...
class TestPawns:
    ...
    @staticmethod
    def test_knight_cant_move_top_board_on_edge():
        # Arrange
        board = Board.empty()
        knight = Knight(Player.BLACK)
    ...
    @staticmethod
    def test_knight_cant_move_top_board_one_before_edge():
        # Arrange
        board = Board.empty()
        knight = Knight(Player.BLACK)
    ...
    @staticmethod
    def test_knight_cant_move_bottom_board_on_edge():
        # Arrange
        board = Board.empty()
        knight = Knight(Player.BLACK)
    ...
    @staticmethod
    def test_knight_cant_move_bottom_board_one_before_edge():
        # Arrange
        board = Board.empty()
        knight = Knight(Player.BLACK)
        square = Square.at(0, 4)
    ...
    @staticmethod
    def test_knight_cant_move_right_board_on_edge():
        # Arrange
        board = Board.empty()
        knight = Knight(Player.BLACK)
    ...
    @staticmethod
    def test_knight_cant_move_right_board_one_before_edge():
        # Arrange
        board = Board.empty()
        knight = Knight(Player.BLACK)
    ...
    @staticmethod
    def test_knight_cant_move_left_board_on_edge():
        # Arrange
        board = Board.empty()
        knight = Knight(Player.BLACK)
    ...
    @staticmethod
    def test_knight_cant_move_left_board_one_before_edge():
        # Arrange
        board = Board.empty()
        knight = Knight(Player.BLACK)
        square = Square.at(4, 0)
